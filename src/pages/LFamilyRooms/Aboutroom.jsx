        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl  duration-300 flex flex-col">
            ...
            <p className="text-gray-600 mb-6 text-lg italic border-l-4 border-blue-500 pl-4">
              " Perfect for family vacations, these rooms create a warm and
              welcoming environment where togetherness meets comfort. "
            </p>

            <p className="text-gray-700 mb-3 leading-relaxed">
              Planning a trip with family or friends? Our 4-Bedded Super Deluxe
              AC Rooms are designed to offer spacious comfort and convenience
              for small groups or families. With flexible bedding options, these
              rooms combine modern style with home-like comfort.
            </p>
            <p className="text-gray-700 mb-3 leading-relaxed">
              Each room is equipped with air-conditioning, cozy interiors, clean
              linens, and essential amenities to ensure a relaxed and enjoyable
              stay.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-8">
              <div className="bg-blue-50/50 p-5 rounded-xl border border-blue-100">
                ...
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li>✔ Size: 10 m² / 25 ft²</li>

                  <li>✔ Two Double Bedded Room</li>
                </ul>
              </div>
