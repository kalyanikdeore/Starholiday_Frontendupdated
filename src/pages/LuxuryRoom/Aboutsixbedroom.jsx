        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl  duration-300 flex flex-col">
            ...
            <p className="text-gray-700 mb-3 leading-relaxed">
              Traveling with a big family or group? Our 6-Bedded Super Deluxe AC
              Suite offers the perfect combination of space, privacy, and
              comfort. With options of twin size beds, this large suite includes
              a common area, ideal for relaxing or socializing after a day of
              sightseeing.
            </p>
            <p className="text-gray-700 mb-3 leading-relaxed">
